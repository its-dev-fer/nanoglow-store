      ...
      <div className="container mx-auto flex justify-between items-center w-1/2">
        ...
        {!isSearchVisible && (
          <div className="flex-grow mx-4 flex justify-center space-x-4">
            <Link to="/impresoras" className="text-black-300 hover:text-purple-600">
              Impresoras
            </Link>
            <Link to="/modelos3d" className="text-black-300 hover:text-purple-600">
              Modelos 3D
            </Link>
            <Link to="/filamentos" className="text-black-300 hover:text-purple-600">
              Filamentos
            </Link>
            <Link to="/cursos" className="text-black-300 hover:text-purple-600">
              Cursos
            </Link>
          </div>
        )}
        ...
        <div className="flex items-center space-x-4">
          ...
          <div className="flex flex-col items-center">
            ...
            <Link to="/login" className="text-black-300 hover:text-purple-600">
              Inicio Sesión
            </Link>
          </div>
        </div>
